...
import HautevilleHouse.ContinuedFractionsComplexAnalyticAspectsTheoremCanonicalLaneLean.Formalization
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "ContinuedFractionsComplexAnalyticAspects",
  theoremObject := "Convergence of continued fractions in complex domains",
